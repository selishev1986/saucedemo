...
def test_remove_product_from_cart_different_users(set_up, username, password):
    page = set_up
    ...
    assert cart_page.cart_image.is_hidden(), f"Produkt wurde für {username} nicht korrekt gelöscht"
