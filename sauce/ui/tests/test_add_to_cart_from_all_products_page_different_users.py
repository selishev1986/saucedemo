...
def test_add_to_cart_from_all_products_page_different_users(set_up, username, password):
    page = set_up
    ...
    assert products_page.cart_image.is_visible(), f"Produkt wurde für {username} nicht korrekt hinzugefügt"
