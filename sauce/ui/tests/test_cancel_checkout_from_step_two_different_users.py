...
def test_cancel_checkout_from_step_two_different_users(set_up, username, password):
    page = set_up
    ...
    checkout_step_two.cancel_checkout()

    assert products_page.products_container.is_visible(),f"Bei {username} wurde checkout cancel nicht korrekt durchgeführt"
