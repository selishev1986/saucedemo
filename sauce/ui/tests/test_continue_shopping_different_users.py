...
def test_continue_shopping_different_users(set_up, username, password):
    page = set_up
    ...
    assert products_page.products_container.is_visible(), f"{username} wurde nicht korrekt zum Continue Shopping weitergeleitet"
